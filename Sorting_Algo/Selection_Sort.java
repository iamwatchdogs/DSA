...
public class Selection_Sort {
    ...
    public static void selection_Sort(int [] arr ) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            // By the end of one i-th iteration, we will have one
            // element sorted in its position. And the elements which
            // get sorted first are the smaller valued elements.
        }
